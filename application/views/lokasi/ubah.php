        ...
        <div class="box-body">
          ...
          <div class="form-horizontal">
            <div class="form-group">
              ...
              <div class="col-md-6">
                <input type="text" class="form-control" name="kode" value="<?php echo $listdata->row()->kode; ?>" placeholder="xxx" maxlength="3">
              </div>
            </div>
            <br>
            <div class="form-group">
              ...
              <div class="col-md-6">
                <input type="text" class="form-control" name="lokasi" value="<?php echo $listdata->row()->lokasi; ?>">
              </div>
            </div>
            <br>
            <div class="form-group">
              ...
              <div class="col-md-6">
                <input type="text" class="form-control" name="heat" value="<?php echo $listdata->row()->heat; ?>">
              </div>
            </div>
            <br>
            <div class="form-group">
