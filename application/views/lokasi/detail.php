		...
		<div class="col-md-12">
          ...
          <table class="table">
            <tbody>
              ...
              <tr>
                <td>Pimpinan</td>
                <td>: <?php if(empty($listdata->row()->heat)) {echo '-';} else echo $listdata->row()->heat;?></td>
              </tr>
              <tr>
                <td>Alamat</td>
          ...
          <?php echo anchor('lokasi','Kembali', array('class'=>'btn btn-sm btn-default btn-flat pull-left','title'=>'Kembali', 'data-toggle'=>'tooltip', 'data-placement'=>'top'))?>
        </div>
			</div>
		</div>
	</div>
