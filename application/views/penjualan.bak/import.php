  		...
  		<div class="col-md-12">
  			<div class="box box-warning">
  				<div class="box-header">
  					<h3 class="box-title">Import Jenis</h3>
            <div class="box-tools pull-right" style="display: -webkit-inline-box">
            	<?php echo anchor('souvenirtype','<i class="fa fa-close"></i>', array('class'=>'btn btn-box-tool','title'=>'Batal', 'data-toggle'=>'tooltip', 'data-placement'=>'top'))?>
            </div>
  				</div>
  				<div class="box-body">
            <?php
                ...
                <div class="col-md-6 input-group">
                  <span class="input-group-btn">
                    <div class="btn btn-default btn-flat">
                      ...
                      <input type="file" accept="application/vnd.ms-excel" name="userfile"/>
                    </div>
                  </span>
