      ...
      <div class="box box-warning">
        <div class="box-header">
          ...
          <div class="box-tools pull-right" style="display: -webkit-inline-box">
            <?php echo anchor('blog','<i class="fa fa-close"></i>', array('class'=>'btn btn-box-tool','title'=>'Batal', 'data-toggle'=>'tooltip', 'data-placement'=>'top'))?>
          </div>
        </div>
        <div class="box-body">
          <?php
          ...
          <div class="form-horizontal">
            <div class="form-group">
              ...
              <div class="col-md-6">
                <input type="text" class="form-control" name="product" value="<?php echo set_value('product'); ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-md-3">Diskripsi</label>
              <div class="col-md-6">
                <textarea class="form-control" name="diskripsi" id="" rows="5"><?php echo set_value('diskripsi'); ?></textarea>
              </div>
            </div>
            <div class="form-group">
