		...
		<div class="col-md-12">
			<div class="box box-warning">
				<div class="box-header">
					<h3 class="box-title">Ubah Provider</h3>
          ...
          <div class="form-horizontal">
            <div class="form-group">
              ...
              <div class="col-md-6">
                <input type="text" class="form-control" name="kode" value="<?php echo $listdata->row()->kode; ?>" maxlength="2">
              </div>
            </div>
            <br>
            <div class="form-group">
              ...
              <div class="col-md-6">
                <input type="text" class="form-control" name="provider"  value="<?php echo $listdata->row()->provider; ?>">
              </div>
            </div>
            <br>
            <div class="form-group">
